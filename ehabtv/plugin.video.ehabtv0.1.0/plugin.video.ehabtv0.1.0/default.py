...
ADDON=xbmcaddon.Addon(id='plugin.video.ehabtv')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/AFVEPkWTlrSGxhIl/wizard.txt?download=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Ehab Wizard","Downloading ",'', 'Please Wait')
